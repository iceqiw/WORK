package com.cwgj.system.mq.alilmq;

import com.alibaba.fastjson.JSON;
import com.alibaba.fastjson.JSONObject;
import com.cwgj.system.mq.common.define.MqTokenType;
...
import com.cwgj.system.mq.common.util.Tools;
...
public class AliyunMQTokenUtil {
  ...
  public static String applyToken(MqTopic... topicArr)
  ...
  public static void main(String[] args)
      throws UnrecoverableKeyException, NoSuchAlgorithmException, KeyManagementException, KeyStoreException, InvalidKeyException, IOException {
    String token = AliyunMQTokenUtil.applyToken(MqTopicDefine.parentTopic,
        new MqTopic(MqTopicDefine.parentTopic.getTopicName() + "/3333333333", QoS.QoS1));
