package com.cwgj.system.mq.common.define;

/**
 * MQ的topic,传输质量默认：QoS1 tokenExpireTime、tokenType和tokenPermission使用token方式鉴权访问的时候，这两个字段才有效 Created
 * by linwb on 2017/12/15 0015.
 */
public class MqTopic {
  ...
  public MqTopic(String topicName) {
    this.topicName = topicName;
    this.qos = QoS.QoS1;
  }

  public MqTopic(String topicName, QoS qos, MqTokenType tokenType,
      MqTokenPermission tokenPermission,
